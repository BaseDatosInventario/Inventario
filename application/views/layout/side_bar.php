              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Venta <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                 <li><?php echo anchor("C_redireccionar/venta", "<span class='glyphicon glyphicon-user'></span> &nbsp;Venta"); ?></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url("Maqueta/images/img.jpg");?>" alt=""><?php echo $this->session->userdata('nombre')." ".$this->session->userdata("ap_paterno"); ?>
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="<?php echo base_url("index.php/C_login/cerrar_sesion") ?>"><i class="fa fa-sign-out pull-right"></i> Cerrar Sesión</a></li>
                  </ul>
                </li>
